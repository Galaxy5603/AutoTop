local A_1 = "Auto Top By : BLK_Galaxy NEW UPDATE :  TP TO ME I CARRY."
local A_2 = "All"
...
coroutine.wrap(function()
    ...
    run.Stepped:connect(function()
        ...
        plr.PlayerGui.HUD.Bottom.SP.TextColor3 = Color3.fromRGB(0, 105, 255)
                        ...
                        if game.workspace.Live.Jiren.Humanoid.Health <= 0 then
                            if isfile(filename) then
                                ...
                                if tonumber(Highscore) > _G.timer then
                                    ...
                                    message.Text = "New best time : ".._G.timer.."! it's "..diff.." seconds faster than your last record ".. Highscore
                                ...
                                if (writefile)then
                                    ...
                                    writefile(filename, json)
                                    local message = Instance.new("Message", game.CoreGui)
                                    message.Text = "Your time is : ".._G.timer..", Hope you do better next time"
                                end
                            end
                        end
                    end
